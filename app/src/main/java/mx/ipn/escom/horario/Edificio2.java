...
public class Edificio2 extends AppCompatActivity {
    private TextView textView;
    private List<String> salones;
    private GridView gridView;
    private Button edif1;
    private String hora;
    private String dia;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edificio2);

        edif1 = (Button) findViewById(R.id.Edificio1);
        ...
        if(bundle != null && bundle.getString("hora") != null && bundle.getString("dia") != null){
            ...
            Toast.makeText(Edificio2.this, "Vacio", Toast.LENGTH_LONG).show();
        }
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Edificio2.this,ReservarActivity.class);
                ...
                Toast.makeText(Edificio2.this, "Seleccionado: "+salones.get(position), Toast.LENGTH_LONG).show();
            }
        });
        ...
        //Listeners
        edif1.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                //Acceder a la pagina Edificio
                Intent intent = new Intent(Edificio2.this,Edificio.class);
    ...
    private void getDatos() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Edificio2.this);
